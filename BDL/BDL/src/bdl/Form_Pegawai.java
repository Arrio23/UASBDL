...
public class Form_Pegawai extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Pegawai", "Nama Pegawai", "Alamat", "Nomor Telpon"
            }
        ));
        ...
        dataBarang.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 245, 655, 300));
        ...
        dataBarang.add(jTextFieldAlamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(326, 198, 130, -1));
        dataBarang.add(jTextFieldNomor, new org.netbeans.lib.awtextra.AbsoluteConstraints(486, 198, 130, -1));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nama", "Alamat", "Nomor" }));
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
        ...
        try {
            String sql = "DELETE FROM pegawai WHERE id_pegawai = '" + jTextFieldID.getText() + "'";
            java.sql.Connection conn = (Connection) koneksi.configDB();
    ...
    private void bt_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_tambahActionPerformed
        ...
        try {
            ...
            stat.setString(4, jTextFieldNomor.getText());
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE pegawai SET nama_pegawai='" + jTextFieldNama.getText() + "', alamat='" + jTextFieldAlamat.getText() + "', no_telp_pegawai='" + jTextFieldNomor.getText() + "' WHERE id_pegawai='" + jTextFieldID.getText() + "'";
    ...
    private void jTextFieldCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCariKeyReleased
        ...
        try {
            ...
            if (jComboBox1.getSelectedIndex() == 0) {
                ...
                String sql = "SELECT * FROM pegawai WHERE nama_pegawai ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'";
                PreparedStatement stat = conn.prepareStatement(sql);
                ResultSet res = stat.executeQuery();
                while (res.next()) {
                    model.addRow(new Object[]{res.getString(1), res.getString(2), res.getString(3), res.getString(4)});
                ...
                String sql = "SELECT * FROM pegawai WHERE alamat ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'" ;
                PreparedStatement stat = conn.prepareStatement(sql);
                ResultSet res = stat.executeQuery();
                while (res.next()) {
                    model.addRow(new Object[]{res.getString(1), res.getString(2), res.getString(3), res.getString(4)});
