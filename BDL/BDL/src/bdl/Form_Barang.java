...
public class Form_Barang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        dataBarang.add(jTextFieldJumlah, new org.netbeans.lib.awtextra.AbsoluteConstraints(326, 198, 130, -1));
        dataBarang.add(jTextFieldHarga, new org.netbeans.lib.awtextra.AbsoluteConstraints(486, 198, 130, -1));
    ...
    private void jButtonHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonHapusActionPerformed
        ...
        try {
            String sql = "DELETE FROM barang WHERE id_barang = '" + jTextFieldID.getText() + "'";
            java.sql.Connection conn = (Connection) koneksi.configDB();
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        try {
            String sql = "UPDATE barang SET nama_barang='" + jTextFieldNama.getText() + "', jumlah_br_sup= " + jml + ", harga=" + hrg + " WHERE id_barang='" + jTextFieldID.getText() + "'";
